<div class="modal fade" id="modal-tsu" tabindex="-1" role="dialog" aria-labelledby="modal-tsu">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{route ('ssup')}}" method="post" class="form-horizontal">
            @csrf
            @method('post')

            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="mt-2 mb-2" style="margin-inline-end: 20px; margin-inline-start:20px;">Tambah Supplier</h4>
                ...
                <div class="modal-body" style="margin-inline-end: 20px; margin-inline-start:20px;">
                    ...
                    <div class="form-group row">
                        <label for="email" class="col-lg-12 col-lg-offset-1 control-label mt-2">Email</label>
                        <div class="col-lg-12">
