    ...
    <div class="card-box mb-30">
        <div class="card-body">
            ...
            <div class="card-tools mb-4 mt-3">
                ...
                <div class="col-6">
                <div class="d-flex ">
                    <button class="btn btn-success shadow rounded-3 border-0" data-toggle="modal" data-target="#modal-jenis" style="border-color: #35A29F; background-color:#35A29F;" data-color="#fff">
                        <i class="icon-copy fa fa-plus-square" aria-hidden="true" data-color="#fff"></i>
                        &nbsp;Tambah
                    </button>
                    </div>
